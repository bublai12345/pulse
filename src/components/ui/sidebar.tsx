...
function SidebarHeader({ className, ...props }: React.ComponentProps<"div">) {
	return (
		<div
			...
			data-sidebar="header"
			className={cn("flex flex-col gap-2 justify-center px-2 h-14 border-b group-has-data-[collapsible=icon]/sidebar-wrapper:h-12", className)}
			{...props}
		/>
	);
}
...
function SidebarGroup({ className, ...props }: React.ComponentProps<"div">) {
	return (
		<div
			...
			data-sidebar="group"
			className={cn("relative flex w-full min-w-0 flex-col px-2 pt-2", className)}
			{...props}
		/>
	);
}
